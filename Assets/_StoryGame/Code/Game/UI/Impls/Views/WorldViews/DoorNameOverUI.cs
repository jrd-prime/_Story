...
namespace _StoryGame.Game.UI.Impls.Views.WorldViews
{
    ...
    public sealed class DoorNameOverUI : MonoBehaviour
    {
        ...
        private void OnAppStarted(Unit _)
        {
            ...
            _panelSettings.name = "PlayerOverheadTipPanelSettings";


            var initializer = new TipInitializer(_log);
            initializer.Init(new WorldTipData(_uiDocument, visualTreeAsset, transform, _meshFilter, _meshRenderer,
                renderTextureAsset, _panelSettings, panelWidth, panelHeight, panelScale, pixelsPerUnit,
