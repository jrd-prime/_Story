    ...
    public sealed class InspectSystem : AInteractableSystem<IInspectable>
    {
        ...
        private async UniTask OnStartInspect()
        {
            ...
            try
            {
                ...
                {
                    Log.Debug("Inspect progress complete - CLOSE");
                }
        ...
        private async UniTask ShowLootTipAfterInspect()
        {
            ...
            var tipLocalizationId = hasLoot
                ? InteractableSystemTipData.GetRandomTip(EInteractableSystemTip.InspHasLoot)
                : InteractableSystemTipData.GetRandomTip(EInteractableSystemTip.InspNoLoot);
