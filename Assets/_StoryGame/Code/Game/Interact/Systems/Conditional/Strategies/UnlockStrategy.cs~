...
namespace _StoryGame.Game.Interact.Systems.Conditional.Strategies
{
    ...
    /// </summary>
    /// <returns></returns>
    public class UnlockObjectStrategy : IConditionalSystemStrategy
    {
        public string StrategyName => nameof(UnlockObjectStrategy);
        private readonly InteractSystemDepFlyweight _systemDep;

        public UnlockObjectStrategy(InteractSystemDepFlyweight systemDep) => _systemDep = systemDep;
