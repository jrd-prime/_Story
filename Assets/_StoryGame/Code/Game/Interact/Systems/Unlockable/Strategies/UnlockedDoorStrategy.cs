...
namespace _StoryGame.Game.Interact.Systems.Unlockable.Strategies
{
    public sealed class UnlockedDoorStrategy : IPassSystemStrategy
    {
        ...
        public async UniTask<bool> ExecuteAsync(IPassable interactable)
        {
            ...
            var localizedDoorAction = _dep.L10n.Localize(_door.OpenableObjData.doorAction.ToString(), ETable.Words);

            var localizedRoomName = _door.OpenableObjData.doorAction switch
            {
                EDoorAction.EnterQ => _dep.L10n.Localize(_door.OpenableObjData.toRoom.ToString(), ETable.Words),
                EDoorAction.ExitQ => _dep.L10n.Localize(_door.OpenableObjData.fromRoom.ToString(), ETable.Words),
                EDoorAction.AscendQ => _dep.L10n.Localize(_door.OpenableObjData.toRoom.ToString(), ETable.Words),
                EDoorAction.DescendQ => _dep.L10n.Localize(_door.OpenableObjData.toRoom.ToString(), ETable.Words),
            ...
            IUIViewerMsg msg = new ShowExitRoomWindowMsg(exitLocalizedName, question, _door.OpenableObjData.usePrice, source);
