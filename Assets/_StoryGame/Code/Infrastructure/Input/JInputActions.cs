...
public partial class @JInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@JInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, JInputActions.Player.Disable() has not been called.");
    ...
    public struct PlayerActions
    {
        ...
        public PlayerActions(@JInputActions wrapper) { m_Wrapper = wrapper; }
